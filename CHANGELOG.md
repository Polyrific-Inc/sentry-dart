...
- Bump Android SDK from v7.14.0 to v7.18.0 ([#33](https://github.com/Polyrific-Inc/sentry-dart/pull/33))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#7180)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.14.0...7.18.0)
