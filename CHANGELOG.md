...
- Bump Android SDK from v7.14.0 to v8.6.0 ([#45](https://github.com/Polyrific-Inc/sentry-dart/pull/45))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#860)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.14.0...8.6.0)
