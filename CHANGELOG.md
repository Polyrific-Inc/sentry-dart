...
- Bump Android SDK from v7.14.0 to v8.7.0 ([#46](https://github.com/Polyrific-Inc/sentry-dart/pull/46))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#870)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.14.0...8.7.0)
