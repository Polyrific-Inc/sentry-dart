...
- Bump Android SDK from v7.14.0 to v8.3.0 ([#42](https://github.com/Polyrific-Inc/sentry-dart/pull/42))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#830)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.14.0...8.3.0)
