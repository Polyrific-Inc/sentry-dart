...
- Bump Android SDK from v7.14.0 to v7.18.1 ([#34](https://github.com/Polyrific-Inc/sentry-dart/pull/34))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#7181)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.14.0...7.18.1)
