...
- Bump Android SDK from v7.14.0 to v8.2.0 ([#41](https://github.com/Polyrific-Inc/sentry-dart/pull/41))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#820)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.14.0...8.2.0)
