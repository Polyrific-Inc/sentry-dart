...
- Bump Android SDK from v7.14.0 to v8.0.0 ([#39](https://github.com/Polyrific-Inc/sentry-dart/pull/39))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#800)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.14.0...8.0.0)
