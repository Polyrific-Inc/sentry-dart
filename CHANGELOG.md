...
- Bump Android SDK from v7.14.0 to v8.5.0 ([#44](https://github.com/Polyrific-Inc/sentry-dart/pull/44))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#850)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.14.0...8.5.0)
